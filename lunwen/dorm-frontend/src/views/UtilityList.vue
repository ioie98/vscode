    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="header-actions">
          ...
          <el-tag v-if="user.role === 0" style="margin-left: 10px; margin-bottom: 10px;" type="">全校账单</el-tag>
          <el-tag v-if="user.role === 1" style="margin-left: 10px; margin-bottom: 10px;" type="success">本宿舍账单</el-tag>
      ...
      >
        <el-table-column label="宿舍" width="240" align="center">
        ...
        <el-table-column label="操作" width="240" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <span v-if="user.role === 1 && row.status === 1" style="color: #67c23a; font-size: 12px;">已缴费</span>
          </template>
        </el-table-column>
      </el-table>
