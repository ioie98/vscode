...
def batch_download():
    try:
        ...
        overall_results = []
        merged_results = []  # 用于返回每个下载文件的信息，不做合并
        ...
        return jsonify({'status': 'success', 'details': overall_results, 'merged': merged_results})
    except Exception as e:
        traceback_str = traceback.format_exc()
