...
def batch_download():
    try:
        ...
        for device in devices:
            ...
            try:
                ...
                for data_type in types:
                    # _download_single_type_for_device 内部要改写成写入 mode_dir
                    res = _download_single_type_for_device(device, data_type, start_time, end_time, priority_list, save_dir=mode_dir)
        ...
        # 合并逻辑，传 mode 与时间范围
        try:
            merged = merge_datasets_inner(devices, mode, start_time, end_time)
        except Exception as e:
