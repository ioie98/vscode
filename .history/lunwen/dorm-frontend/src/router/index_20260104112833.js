...
import ReturnRegister from '../views/ReturnRegister.vue'  // 返校登记（管理员专用）
import UtilityList from '../views/UtilityList.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/return-register', component: ReturnRegister, meta: { title: '返校登记' } },
      ]
    }
  ]
})
