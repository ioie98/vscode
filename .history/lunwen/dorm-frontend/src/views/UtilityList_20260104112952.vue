    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="header-actions">
          ...
          <el-button v-if="user.role === 0" type="primary" icon="Plus" @click="openAddDialog">发布账单</el-button>
      ...
      >
        ...
        <el-table-column label="操作" width="120" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <span v-else style="color: #67c23a; font-size: 12px;">无需操作</span>
          </template>
        </el-table-column>
      </el-table>
      ...
      <!-- 管理员发布账单弹窗 -->
      <el-dialog v-model="dialogVisible" title="发布水电费账单" width="500px">
        <el-form :model="form" label-width="100px">
          <el-form-item label="选择宿舍">
            <el-select v-model="form.dormId" placeholder="请选择" filterable style="width: 100%">
              <el-option
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="用水(吨)">
                <el-input-number v-model="form.waterUsage" :precision="1" :step="0.1" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="水费(元)">
                <el-input-number v-model="form.waterCost" :precision="2" :step="1" style="width: 100%" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="用电(度)">
                <el-input-number v-model="form.electricUsage" :precision="1" :step="1" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="电费(元)">
                <el-input-number v-model="form.electricCost" :precision="2" :step="1" style="width: 100%" />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
const submitAdd = () => {
  ...
  axios.post('http://localhost:8080/api/utility/add', form).then(res => {
    if(res.data.code === 200) {
