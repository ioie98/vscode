<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <div class="filter-header" style="padding-bottom: 15px; border-bottom: 1px dashed #eee; display: flex; justify-content: flex-end; margin-top: 5px;">
        <span>去向筛选：</span>
        <el-select v-model="query" placeholder="全部" style="width: 150px; margin-left: 10px; margin-right: 10px; margin-top: 5px;" @change="fetchData">
