<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        <el-table-column label="宿舍" width="150" align="center">
        ...
        <el-table-column prop="checkDate" label="检查日期" width="180" align="center">
        ...
        <el-table-column prop="remark" label="检查情况 / 备注" align="center"/>
      </el-table>
