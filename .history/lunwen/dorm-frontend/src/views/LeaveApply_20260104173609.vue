    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="header-actions">
          ...
          <el-tag v-else-if="user.role === 2" size="large" type="warning" style="margin-left: 10px; margin-bottom: 5px;">维修工申请</el-tag>
      ...
      >
        <el-table-column prop="studentName" label="申请人" width="120" align="center"/> 
          <!-- 新增：宿舍列 -->
        <el-table-column prop="dormName" label="宿舍" width="180" v-if="user.role === 0 || user.role === 2" align="center">
          <template #default="{ row }">
            <el-tag size="small" type="info">{{ row.dormName || '暂无宿舍' }}</el-tag>
          </template>
        </el-table-column>
