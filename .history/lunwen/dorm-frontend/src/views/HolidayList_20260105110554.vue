-- Active: 1765873153857@@115.190.81.184@30730@mysql
<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <div class="filter-header" style="margin-top: -20px; padding-bottom: 0px; border-bottom: 1px dashed #eee; display: flex; justify-content: flex-end;">
        <!-- <span>去向筛选：</span> -->
        <el-select v-model="query" placeholder="全部" style="margin-top: -15px;margin-bottom: 10px;width: 150px; margin-left: 10px; margin-right: 10px;" @change="fetchData">
          <el-option label="全部" value="全部" /><el-option label="留校" value="留校" /><el-option label="回家" value="回家" /><el-option label="其他" value="其他" />
        </el-select>
        <el-button type="primary" icon="Search" style="margin-top: -15px;margin-bottom: 10px;" @click="fetchData">查询</el-button>
      </div>
      ...
      <el-table :data="tableData" border stripe style="margin-top: 20px;" :header-cell-style="{ background: '#f5f7fa', color: '#606266', fontWeight: 'bold' }">
        ...
        <!-- 宿舍列 -->
        <el-table-column label="宿舍" width="180" align="center">
