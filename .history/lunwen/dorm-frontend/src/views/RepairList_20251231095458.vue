    ...
    <el-card class="box-card">
      <div slot="header" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="header-actions">
          <el-button v-if="userRole === 1" type="primary" icon="Plus" style="margin-bottom: 10px;" @click="handleCreate">我要报修</el-button>
          <el-checkbox v-if="userRole !== 1" v-model="showOnlyPending" label="只看待处理" @change="fetchData" style="margin-left: 15px;" border />
          <el-button icon="Refresh" circle @click="fetchData" style="margin-left: 10px;margin-bottom: 10px; "></el-button>
        </div>
      </div>
