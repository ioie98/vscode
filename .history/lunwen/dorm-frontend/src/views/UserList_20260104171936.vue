    ...
    <el-card class="box-card">
      ...
      <div style="margin: 20px 0;">
        <el-radio-group v-model="filterRole" @change="fetchData">
          ...
          <el-radio-button :label="2">维修人员</el-radio-button>
      ...
      >
        ...
        <el-table-column label="角色" width="100" align="center">
          <template #default="{ row }">
            ...
            <el-tag v-else type="warning" size="small">维修人员</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="phone" label="联系电话" width="150" align="center"/>
        
        <!-- 学生特有信息 -->
        <el-table-column label="宿舍/班级信息" min-width="200" show-overflow-tooltip align="center">
          <template #default="{ row }">
            <div v-if="row.role === 1">
        ...
        <el-form :model="form" label-width="80px">
          <el-form-item label="角色">
            <el-radio-group v-model="form.role" :disabled="isEditMode">
              ...
              <el-radio :label="2">维修人员</el-radio>
