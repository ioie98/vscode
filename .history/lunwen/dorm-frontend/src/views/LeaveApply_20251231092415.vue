    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="header-actions">
          ...
          <el-tag v-if="user.role === 0" size="large" style="margin-left: 10px; margin-bottom: 10px;">全校审批</el-tag>
          <el-tag v-else-if="user.role === 1" size="large" type="success" style="margin-left: 10px; margin-bottom: 10px;">本宿舍申请</el-tag>
          <el-tag v-else-if="user.role === 2" size="large" type="warning" style="margin-left: 10px;">维修工申请</el-tag>
