    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            if dtype == 'pwv':
                ...
                if item['pwv'] is None and to_float(row.get('lon')) is None: continue # 简单过滤
            elif dtype == 'weather':
                item.update({
